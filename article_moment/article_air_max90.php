...
<!--     images  -->
  ...
  <div class="collapse" id="collapseExample">
    ...
    <form method="POST" action="article_air_max90.php">    
     <div class="row">
        <div class="col-sm-12"> 
            <div class="formulaire">
                <form method="POST" class="form" action="article_air_max90.php">
                    ...
                    <div class="form-group">
                      ...
                      <input name="code_produit" type="hidden" value="air_max90">  
